...
const EmailPhoneWebsite = (props) => {
  ...
  return ( 
    <React.Fragment>
      <div className="form-group" style={{'display': `${formHidden.email?'none':'block'}`}}>
      ...
      <div className="form-group" style={{'display': `${formHidden.phone?'none':'block'}`}}>
      ...
      <div className="form-group" style={{'display': `${formHidden.website?'none':'block'}`}}>
